...
router.post('/',async (req,res)=>{
    ...
    try{
     ...
     const hashpassword=await bcrypt.hash(password,salt)
      ...
      console.log(token)
      const Link=`https://auth-backend-6dn1.onrender.com/changepass/${token}`
     // const Link=`http://localhost:4000/changepass/${token}`
      const content=` 
      <!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="container">
        ...
        <p>We received a request to reset the password associated with your account. If you did not initiate this request, please disregard this email, and consider reviewing the security of your account.</p>
